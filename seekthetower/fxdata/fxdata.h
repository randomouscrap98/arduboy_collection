...
// Generated with ardugotools on 2025-06-02T02:06:09-04:00
...
constexpr uint24_t itemnames = 0x021AE4;
constexpr uint24_t itemnameoffsets = 0x021B66;
constexpr uint24_t itemstacks = 0x021B82;
constexpr uint24_t itemprices = 0x021B90;
