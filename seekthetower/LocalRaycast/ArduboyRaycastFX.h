...
template <uint8_t SpriteCount, uint8_t InternalStateBytes, uint8_t ScreenWidth,
...
public:
  ...
  RcContainer(const uint24_t tilesheet, const uint24_t spritesheet,
              const uint24_t spritesheet_mask) {
